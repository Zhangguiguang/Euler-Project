...
/*
 ...
 (1,  0) 左 -> 右     20行，0<=y<=19，每一行作为组头的0<=x<=16
 (0,  1) 上 -> 下     20行，0<=x<=19，每一行作为组头的0<=y<=16
 (1,  1) 左上 -> 右下  33行，0<=x<=16，每一行作为组头的0<=y<=19-3-x
 1<=y<=16，每一行作为组头的0<=x<=19-3-y
 (1, -1) 左下 -> 右上  33行，3<=y<=19，每一行作为组头的0<=x<=y-3
 1<=x<=16，每一行作为组头的19>=y>=x+3
 ...
 void runDirection(x, y, flag, start, end, start2, end2)
 x, y 指示方向
 flag, start, end 表示
